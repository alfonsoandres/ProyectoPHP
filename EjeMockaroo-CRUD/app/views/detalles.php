...
<table>
 ...
 <td rowspan="7">
<img src="app\uploads\0000000<?=imagenAleatoria()?>.jpg"></img></td> 
 ...
 <picture>
  <source
    type="image/webp"
    srcset="https://flagcdn.com/192x144/<?=funcionIpPais($cli->ip_address)?>.webp">
  
  <source
    type="image/png"
    srcset="https://flagcdn.com/192x144/<?=funcionIpPais($cli->ip_address)?>.png">
  <img
    src="https://flagcdn.com/192x144/<?=funcionIpPais($cli->ip_address)?>.png"
    width="192"
    height="144"
    alt="<?=funcionIpPais($cli->ip_address)?>">
</picture>
<?php echo funcionIpPais($cli->ip_address);?>
